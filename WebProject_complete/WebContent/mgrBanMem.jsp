...
<div class="jumbotron" style="padding-top: 20px;">
	<div class="container-fluid">
		<form method="post" action="mgrBanMemAction.jsp">
			<h3 style="text-align: center;">회원탈퇴</h3>
			<h5 style="text-align: center;">회원 탈퇴가 진행 된 이후에는 되돌릴 수 없습니다.</h5>
			<div class="form-group">
				<input type="text" class="form-control" placeholder="아이디" name="id" maxlength="20" style="text-align:center;">
			</div><br>
			<p style="text-align:center;">
			<input type="submit" class="btn btn-primary btn-sm form-control" value="탈퇴" style="max-width:50px;">
			<input type="reset" class="btn btn-danger btn-sm form-control" value="취소" style="max-width:50px;" onclick="javascript:window.location='main.jsp'">
			</p>
		</form>
	</div>	
</div>
