...
<div class="jumbotron" style="padding-top: 20px;">
	<div class="container-fluid">
		<h1 id="head" style="color:red">회원정보그래프[개발중]</h1>
		<img src="headache.jpeg" alt="omg" width="600px" height="430px"></img><br>
		<h3 id="head" style="color:red"><strong>개발자가 개발 진행을 못하고 있습니다.</strong></h3>
		<h4 id="head">구원게시판에서 질문답글로 개발자를 구원해주세요.</h4><br>
	</div>
</div>
