...
import com.study.jsp.command.BMemberCommand;
...
import com.study.jsp.command.BSearchMemCommand;
...
public class BFrontController extends HttpServlet {
	...
	protected void actionDo(HttpServletRequest request, HttpServletResponse response)
		...
		if (com.equals("/write_view.do")) {
			...
			command = new BMemberCommand();
			command.execute(request, response);
			viewPage = "mgrInqureMem.jsp";
		} else if (com.equals("/searchMem.do")) {
			command = new BSearchMemCommand();
			command.execute(request, response);
			viewPage = "mgrSearchMem.jsp";
		}
